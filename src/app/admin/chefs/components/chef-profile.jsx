  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
      ...
      <div className="flex flex-col items-center text-center mb-8">
        <div className="h-24 w-24 bg-gradient-to-br from-orange-500 to-red-600 rounded-full flex items-center justify-center mb-4 shadow-2xl relative">
      ...
      <div className="mt-8 pt-6 border-t border-gray-200">
        <div className="flex space-x-3">
          <Link
            ...
            className="flex-1 justify-center bg-gradient-to-r from-orange-500 to-red-600 hover:from-orange-600 hover:to-red-700 text-white py-2 px-4 rounded-lg flex items-center transition-all duration-300"
          >
          ...
          <button className="flex-1 justify-center bg-gray-100 hover:bg-gray-200 text-gray-700 py-2 px-4 rounded-lg flex items-center transition-all duration-300">
            <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="flex space-x-2 mt-3">
          <button className={`flex-1 justify-center text-xs py-2 px-3 rounded-lg transition-all duration-300 ${
            chef.isActive 
          ...
          {!chef.isVerified && (
            <button className="flex-1 justify-center text-xs bg-blue-500 hover:bg-blue-600 text-white py-2 px-3 rounded-lg transition-all duration-300">
              ⭐ Верифицировать
            </button>
          )}
        </div>
